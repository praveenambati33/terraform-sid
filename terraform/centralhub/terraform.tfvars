...
subnets = {
    subnet0 = {
        subnet_name = "eus-hub-central-vm-subnet"   # <-- Test Subnet for test VM
        subnet_address_prefixes = ["172.30.3.0/24"]
    }
    ...
    # }
    # subnet3 = {
    #     name = "eus-nonprod-sit-snet-apim-01"
    #     address_prefixes = ["172.30.253.96/28"]
    # },
    # subnet4 = {
    #     name = "eus-hub-snet-vmss-p-01"
    #     address_prefixes = ["172.30.5.0/28"]
    # },
    # subnet5 = {
    #     name = "eus-hub-snet-jumpbox-p-01"
    #     address_prefixes = ["172.30.254.48/28"]
    # },
    # subnet6 = {
    #     name = "eus-nonprod-qa-subnet-asb-01"
    #     address_prefixes = ["172.30.255.96/28"]
    # },
    # subnet7 = {
    #     name = "eus-test-snet-vmhop-01"
    #     address_prefixes = ["172.30.252.224/27"]
    # },
    # subnet8 = {
    #     name = "eus-nonprod-snet-asb"
    #     address_prefixes = ["172.30.254.64/28"]
    # },
    # subnet9 = {
    #     name = "subnetvm"
    #     address_prefixes = ["172.30.1.0/29"]
    # },
    # subnet10 = {
    #     name = "eus-prod-snet-agw-01"
    #     address_prefixes = ["172.30.255.128/26"]
    # },
    # subnet11 = {
    #     name = "eus-nonprod-snet-apim-01"
    #     address_prefixes = ["172.30.254.96/28"]
    # },
    # subnet12 = {
    #     name = "GatewaySubnet"
    #     address_prefixes = ["172.30.255.224/27"]
    # },
    # subnet13 = {
    #     name = "eus-nonprod-sit-snet-agw-01"
    #     address_prefixes = ["172.30.253.80/28"]
    # },
    # subnet14 = {
    #     name = "eus-nonprod-snet-apim-internal-01"
    #     address_prefixes = ["172.30.255.192/27"]
    # },
    # subnet15 = {
    #     name = "AzureFirewallSubnet"
    #     address_prefixes = ["172.30.255.0/26"]
    # },
    # subnet16 = {
    #     name = "eus-nonprod-qa-snet-apim"
    #     address_prefixes = ["172.30.4.0/28"]
    # },
    # subnet17 = {
    #     name = "eus-hub-snet-compute-p-01"
    #     address_prefixes = ["172.30.240.0/26"]
    # },
    # subnet18 = {
    #     name = "AzureBastionSubnet"
    #     address_prefixes = ["172.30.0.0/27"]
    # },
    # subnet19 = {
    #     name = "testAGWsubnet"
    #     address_prefixes = ["172.30.2.0/28"]
    # },
    # subnet20 = {
    #     name = "eus-nonprod-snet-agw-01"
    #     address_prefixes = ["172.30.254.80/28"]
    # }
}
...
vms = {
    vm1 = {
        ...
        image_publisher     = "Canonical"                       #Need check. Here shared Image is used from garally.
    ...
    vm2 = {
        ...
        address_prefixes    = ["172.30.240.0/26"]                 #uncomment this if you creating VM subnet with VM and provide Subent address prefixes
        ...
        #OSDisk
        osdisk_name         = "eus-hub-central-dns-vm-01_disk1"
        osdisk_caching      = "ReadWrite"
...
virtualmachine_rg_vms = {
    vm1 = {
        ...
        address_prefixes    = ["172.30.1.0/29"]                 #uncomment this if you creating VM subnet with VM and provide Subent address prefixes
        ...
        #storage_image_reference
        image_publisher     = "MicrosoftWindowsServer"          #Need check. Here shared Image is used from garally.
